...
add_users() {
 ...
 sudo adduser oracle
 #sudo adduser darryl
 #sudo mkdir /home/darryl/.ssh
 
 #sudo cp /home/ec2-user/.ssh/authorized_keys /home/oracle/.ssh/*
 sudo cp /home/ec2-user/.ssh/authorized_keys /home/darryl/.ssh/*
 sudo usermod -aG wheel darryl
 #sudo chmod 700 /home/oracle/.ssh
 #sudo chmod 600 /home/oracle/.ssh/authorized_keys
 #sudo chown -R oracle:oracle /home/oracle/*
 #sudo chmod 700 /home/darryl/.ssh
 ##sudo chmod 600 /home/darryl/.ssh/authorized_keys
 #sudo chmod 700 /home/darryl/.ssh
 #sudo chmod 600 /home/darryl/.ssh/authorized_keys
...

{
  ec=0
  logit INFO '-----------------------------------------------'
  logit INFO 'Starting DB Server Install'
  logit INFO '-----------------------------------------------'
  ...
  if [ $ec = "0" ]; then  
    logit INFO '-----------------------------------------------'
    logit INFO 'Completed DB Server Install'
    logit INFO '-----------------------------------------------'
    exit 0
  fi  
}
